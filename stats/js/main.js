...
log('BNbitcoin Stats', version);
el('#footerversion').innerHTML = version;


/* intrinsic values */
const _SECONDS_PER_ETH_BLOCK = 3;
const _ZERO_BN = new Eth.BN(0, 10);

/* contract constants */
/* todo: pull these from the contract */
/* todo: move these into some kind of contract helper class */
const _CONTRACT_NAME = "BNbitcoin";
const _CONTRACT_SYMBOL = "BNBTC";
const _BLOCKS_PER_READJUSTMENT = 2016;
const _CONTRACT_ADDRESS = "0xe7cb24f449973d5b3520e5b93d88b405903c75fb";
const _MINT_TOPIC = "0xcf6fbb9dcea7d07263ab4f5c3a92f53af33dffc421d9d121e1c74b307e68189d";
const _MAXIMUM_TARGET_STR = "26959946667150639794667015087019630673637144422540572481103610249216";  // 2**224
const _MINIMUM_TARGET = 2**16;
const _ETH_BLOCKS_PER_REWARD = 200;
...
var eth = new Eth(new Eth.HttpProvider("https://bsc-dataseed.binance.org"));
...
// }
var _BLOCK_EXPLORER_ADDRESS_URL = 'https://bscscan.com/address/';
var _BLOCK_EXPLORER_TX_URL = 'https://bscscan.com/tx/';
var _BLOCK_EXPLORER_BLOCK_URL = 'https://bscscan.com/block/';
...
/* get last hours_into_past worth of mined bnbtc blocks, save to a CSV file */
function getMinerInfoCSV(eth, stats, hours_into_past){
  ...
  .then((result) => {
    ...
    // Start file download.
    downloadTextAsFile("bnbtc-blocks-" + date_now.toLocaleTimeString() + ".csv",
                       csv_text);
